...
% We use element-wise division (./) just in case a vector is passed, 
% though bisection uses scalars.
f = @(a) cosh(100./a) - 11;
...
% The function handles the printing of the first 3 iterations internally
...
% =========================================================================
% Local Function: Bisection Method
